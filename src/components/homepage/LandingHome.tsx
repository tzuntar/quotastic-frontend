        ...
        <div className="p-10 pb-28">
            ...
            <div id="intro" className="lg:flex lg:flex-row lg:items-center lg:justify-around">
                <div id="intro_text" className="lg:max-w-sm">
                    <h1 className="text-3xl lg:text-6xl lg:font-extralight">Welcome<br/>to <span className="text-orange">Quotastic</span></h1>
            ...
            <h1 className="text-3xl text-center pt-14 lg:pt-28 lg:pb-6 lg:text-5xl lg:font-extralight">Explore the world of <span
                className="lg:text-orange lg:block">fantastic quotes</span></h1>
            ...
            <div className="mb-10">
                <div id="quotes_grid" className="lg:grid lg:grid-cols-3 lg:space-x-10 space-y-6 lg:space-y-10">
                    {quote.isLoading
